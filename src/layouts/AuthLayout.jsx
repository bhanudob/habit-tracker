...
export default function AuthLayout() {
  return (
    <div className="flex flex-col min-h-svh max-w-lg mx-auto bg-gradient-to-br from-teal-50 to-purple-50 dark:from-slate-950 dark:to-slate-900">
      <div className="flex flex-col items-center pt-16 pb-4 px-6">
        ...
        <h1 className="text-xl font-extrabold text-slate-700 dark:text-slate-200">Day Planner</h1>
        <p className="text-slate-400 dark:text-slate-500 text-sm">Plan your day, on the fly.</p>
      </div>
      <Outlet />
    </div>
  )
